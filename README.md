...
> Support de formation **BeCode / BStorm** : les bases de l'administration Linux, puis l'écriture de scripts shell, du premier `pwd` jusqu'à la configuration avancée de son environnement de travail.
...
| 07 | [tmux](07_tmux.md) | Sessions, fenêtres, panneaux, travail à distance |
| 08 | [Configuration du shell](08_shell_config.md) | `.bashrc`, `.zshrc`, `PATH`, prompt, alias, dotfiles |
| 09 | [Configuration avancée](09_advanced_config.md) | Oh My Zsh, Powerlevel10k, Starship, Oh My Tmux, outils modernes |
...
```text
.
├── 01_base.md … 09_advanced_config.md   # les chapitres de cours
...
>
> Le `docker-compose.yml` du dépôt n'est **pas** cet environnement de travail : il ne sert qu'à lancer une base PostgreSQL utilisée en démonstration.
